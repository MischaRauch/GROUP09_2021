...
public class CelestialBodyComponent extends JComponent
{
  ...
  public ArrayList<JPanel> venusA = new ArrayList<JPanel>();
  public ArrayList<JPanel> earthA = new ArrayList<JPanel>();
  public ArrayList<JPanel> moonA = new ArrayList<JPanel>();
  public ArrayList<JPanel> marsA = new ArrayList<JPanel>();
  public ArrayList<JPanel> jupiterA = new ArrayList<JPanel>();
  public ArrayList<JPanel> saturnA = new ArrayList<JPanel>();
  public ArrayList<JPanel> titanA = new ArrayList<JPanel>();
  public ArrayList<JPanel> uranusA = new ArrayList<JPanel>();
  public ArrayList<JPanel> neptunA = new ArrayList<JPanel>();
  ...
  public void paintTrajectory(Graphics2D g)
  {
    ...
    if(sF.stepCount % 150 == 0)
    {
      ...
      for (tmp = oldStepCount; tmp < sF.stepCount; tmp+=500) 
      {
        ...
        //sF.animation.revalidate();
        //sF.animation.repaint();
        //sF.lPane.add(sF.animation);
        //System.out.println("Scale "+ sF.scale);
