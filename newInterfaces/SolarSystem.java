...
public class SolarSystem implements ODESolverInterface, ProbeSimulatorInterface
{
  ...
  private Vector3dInterface[] rocketTrajectory;
  ...
  public SolarSystem(double h, int nSteps)
  {
    ...
    calculateProbeAngle();
    trajectory(new Vector3d(0,0,0), new Vector3d(0,0,0), 120e6, 6000);
    System.out.println("Probe start coordinates: " + locations[11][0]);
    System.out.println("Titan end coordinates: " + locations[8][nSteps-1]);
  }
